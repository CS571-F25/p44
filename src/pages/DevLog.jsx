  ...
  return (
    ...
    >
      ...
      <Accordion alwaysOpen>
        <DevLogEntry
          eventKey="0"
          title="Week 1 - Project setup & first scene"
        >
          <p>
        ...
        <DevLogEntry
          eventKey="3"
          title="Week 4 - UI polish, music, and accessibility"
        >
          <p>
            Styled the site to match the desert wizard artwork using a dark
            fantasy palette. Added the global music toggle, improved keyboard
            focus states, and checked color contrast on text and buttons to stay
            close to WCAG AA guidelines.
          </p>
        </DevLogEntry>
      </Accordion>
    </Container>
